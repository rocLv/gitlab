...
class CreateJobArtifactStates < Gitlab::Database::Migration[1.0]
  ...
  def up
    create_table :job_artifact_states, id: false do |t|
      t.references :ci_job_artifacts, primary_key: true, null: false, foreign_key: { on_delete: :cascade }
    ...
    add_text_limit :job_artifact_states, :verification_failure, 255
  end
