...
| `geo_job_artifacts`                            | Gauge   | 14.5  | Number of job artifacts on primary | `url` |
| `geo_job_artifacts_checksum_total`             | Gauge   | 14.5 | Number of job artifacts tried to checksum on primary | `url` |
| `geo_job_artifacts_checksummed`                | Gauge   | 14.5  | Number of job artifacts successfully checksummed on primary | `url` |
| `geo_job_artifacts_checksum_failed`            | Gauge   | 14.5  | Number of job artifacts failed to calculate the checksum on primary | `url` |
| `geo_job_artifacts_synced`                     | Gauge   | 14.5  | Number of syncable job artifacts synced on secondary | `url` |
| `geo_job_artifacts_failed`                     | Gauge   | 14.5  | Number of syncable job artifacts failed to sync on secondary | `url` |
| `geo_job_artifacts_registry`                   | Gauge   | 14.5  | Number of job artifacts in the registry | `url` |
| `geo_job_artifacts_verification_total`         | Gauge   | 14.5 | Number of job artifacts verifications tried on secondary | `url` |
| `geo_job_artifacts_verified`                   | Gauge   | 14.5 | Number of job artifacts verified on secondary | `url` |
| `geo_job_artifacts_verification_failed`        | Gauge   | 14.5 | Number of job artifacts verifications failed on secondary | `url` |
