...
RSpec.describe Gitlab::BackgroundMigration::BackfillGroupFeatures, schema: 20210820080652 do
  ...
  describe '#perform' do
    it 'creates settings for all group namespaces in range' do
      ...
      expect { subject.perform(1, 4) }.to change { group_features.count }.by(2)
