...
describe('Project Value Stream Analytics mutations', () => {
  ...
  it.each`
    ...
    ${types.INITIALIZE_VSA} | ${'currentGroup'}  | ${{ title: 'cool-group' }}
    ${types.INITIALIZE_VSA} | ${'id'}            | ${1337}
  ...
  it.each`
    ...
    ${types.SET_DATE_RANGE}                       | ${DEFAULT_DAYS_TO_DISPLAY}          | ${'startDate'}           | ${DEFAULT_DAYS_TO_DISPLAY}
