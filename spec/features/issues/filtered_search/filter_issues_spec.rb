...
RSpec.describe 'Filter issues', :js do
  ...
  it 'filters by all available tokens' do
    ...
    select_tokens 'Assignee', '=', user.username, 'Author', '=', user.username, 'Label', '=', caps_sensitive_label.title, 'Milestone', '=', milestone.title, submit: false
  ...
  describe 'filter issues by assignee' do
    context 'only assignee' do
      it 'filters issues by searched assignee' do
        select_tokens 'Assignee', '=', user.username
  ...
  describe 'filter issues by label' do
    context 'only label' do
      ...
      it 'filters issues by multiple labels' do
        select_tokens 'Label', '=', bug_label.title, 'Label', '=', caps_sensitive_label.title
      ...
      it 'filters issues by label containing special characters' do
        ...
        select_tokens 'Label', '=', special_label.title
    ...
    context 'label with multiple words' do
      it 'special characters' do
        ...
        select_tokens 'Label', '=', special_multiple_label.title
      ...
      it 'single quotes' do
        select_tokens 'Label', '=', multiple_words_label.title
      ...
      it 'single quotes containing double quotes' do
        ...
        select_tokens 'Label', '=', double_quotes_label.title
      ...
      it 'double quotes containing single quotes' do
        ...
        select_tokens 'Label', '=', single_quotes_label.title
    ...
    context 'multiple labels with other filters' do
      it 'filters issues by searched label, label2, author, assignee, milestone and text' do
        ...
        select_tokens 'Label', '=', bug_label.title, 'Label', '=', caps_sensitive_label.title, 'Author', '=', user.username, 'Assignee', '=', user.username, 'Milestone', '=', milestone.title, submit: false
        send_keys(search_term, :enter)
  ...
  describe 'filter issues by milestone' do
    context 'only milestone' do
      ...
      it 'filters issues by upcoming milestones' do
        ...
        select_tokens 'Milestone', '=', 'Upcoming'
      ...
      it 'filters issues by started milestones' do
        select_tokens 'Milestone', '=', 'Started'
      ...
      it 'filters issues by milestone containing special characters' do
        ...
        select_tokens 'Milestone', '=', special_milestone.title
      ...
      it 'does not show issues for unused milestones' do
        ...
        select_tokens 'Milestone', '=', new_milestone.title
  ...
  describe 'filter issues by text' do
    ...
    context 'searched text with other filters' do
      it 'filters issues by searched text, author, text, assignee, text, label1, text, label2, text, milestone and text' do
        click_empty_filtered_search_bar
        send_keys 'bug '
        select_tokens 'Author', '=', user.username, submit: false
        send_keys 'report '
        select_tokens 'Label', '=', bug_label.title, submit: false
        send_keys('foo', :enter)
    ...
    context 'sorting' do
      it 'sorts by created date' do
        ...
        expect(find('.issues-list .issue:first-of-type .issue-title')).to have_content(new_issue.title)
      end
    end
  end
