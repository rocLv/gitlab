...
RSpec.describe 'Dropdown base', :js do
  ...
  describe 'behavior' do
    it 'shows loading indicator when opened' do
      slow_requests do
        ...
        expect(page).to have_css '[data-testid="filtered-search-input"] .gl-spinner'
      end
    end
    ...
    it 'hides loading indicator when loaded' do
      ...
      expect(page).not_to have_css '[data-testid="filtered-search-input"] .gl-spinner'
    end
  end
  ...
  describe 'caching requests' do
    it 'caches requests after the first load' do
      ...
      expect(page).to have_css('.gl-filtered-search-suggestion', count: initial_size)
    end
  end
end
