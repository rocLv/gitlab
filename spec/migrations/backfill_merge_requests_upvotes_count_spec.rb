...
RSpec.describe BackfillMergeRequestsUpvotesCount, :migration do
  ...
  let_it_be(:award_emoji_1) { award_emoji.create!(name: 'thumbsup', awardable_type: 'MergeRequest', awardable_id: merge_request_1.id) }
  let_it_be(:award_emoji_2) { award_emoji.create!(name: 'thumbsup', awardable_type: 'MergeRequest', awardable_id: merge_request_2.id) }
  let_it_be(:award_emoji_3) { award_emoji.create!(name: 'thumbsup', awardable_type: 'MergeRequest', awardable_id: merge_request_3.id) }
  let_it_be(:award_emoji_4) { award_emoji.create!(name: 'thumbsdown', awardable_type: 'MergeRequest', awardable_id: merge_request_4.id) }
  let_it_be(:award_emoji_5) { award_emoji.create!(name: 'thumbsup', awardable_type: 'MergeRequest', awardable_id: merge_request_5.id) }
