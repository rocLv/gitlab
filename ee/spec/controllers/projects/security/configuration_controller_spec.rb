  ...
  describe 'GET #show' do
    ...
    context 'with developer and security dashboard feature enabled' do
      ...
      it 'responds in json format when requested' do
        ...
        types = %w(sast dast dast_profiles dependency_scanning container_scanning running_container_scanning secret_detection coverage_fuzzing license_scanning api_fuzzing)
