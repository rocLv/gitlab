  ...
  module Dashboard
    class UpdateDashboardService < ::BaseService
      ...
      def check_branch_name(result)
        ...
        return error('There was an error updating the dashboard, branch named: %{branch} already exists.' % { branch: params[:branch] }, :bad_request) unless new_or_default_branch?
